...
class ByteTrackOT:
    def __init__(self, model_name: str, output_json='track_results_bytetrack.json'):
        ...
        print("modelloaded")
        print(model_name)  # Load YOLO model
    ...
    def run(self, video_path: str):
        ...
        while cap.isOpened():
            ...
            # Run YOLO inference with built-in ByteTrack
        ...
        # Call the save_results method to save the tracking data
